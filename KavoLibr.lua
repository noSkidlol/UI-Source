    ...
    function Tabs:NewTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            local function updateSectionFrame()
                ...
                UpdateSize()
            local Elements = {}
            function Elements:Button(bname, callback)
                showLogo = showLogo or true
                local ButtonFunction = {}
                tipINf = "No Description" 
            ...
            function Elements:Box(tname, callback)
                ...
                function Elements:Toggle(tname, callback)
                    local TogFunction = {}
            ...
            function Elements:Slider(slidInf, maxvalue, minvalue, callback)
                slidInf = slidInf or "Slider"
                slidTip = "No Description" 
            ...
            function Elements:Keybind(keytext, first, callback)
                keytext = keytext or "KeybindText"
                keyinf = "No Description" 
                callback = callback or function() end
            ...
            function Elements:Color(colText, defcolor, callback)

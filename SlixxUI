...
function lib:NewTab(name, desc)
	...
	function tabFuncs:Slider(name,minimium,maximium,default,callback)
...
--[[
	function tabFuncs:Dropdown(name,list,default,callback)
	...
	function tabFuncs:Box(name,placeholdertext,callback)

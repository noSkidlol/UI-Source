--[[
  // Created by Yamete#2273
  // Looks like Wally Lib
]]

local library = {count = 0};

local FindLibrary = game.CoreGui:FindFirstChild("UI Library")
if game.CoreGui:FindFirstChild("UI Library") then
	game.CoreGui:FindFirstChild("UI Library"):Destroy()
end
...
function library:Window(WName)
	...
	WindowText.Text = WName or "GepoLib"
	...
	function ui:Slider(name,min,max,precise,callback)
		...
		Slider.BackgroundColor3 = Color3.fromRGB(90, 255, 115)
	...
	function ui:Init() --// fix the most problem in UI!
		local ButtonHolder2 = Instance.new("Frame")
		ButtonHolder2.Name = "ButtonHolder"
		ButtonHolder2.Parent = Container
		ButtonHolder2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		ButtonHolder2.BackgroundTransparency = 1.000
		ButtonHolder2.BorderSizePixel = 0
		ButtonHolder2.Position = UDim2.new(0, 0, 0.519480586, 0)
		ButtonHolder2.Size = UDim2.new(0, 200, 0, 37)
		ButtonHolder2.ZIndex = 2
           ui:Resize()
        end
	return ui
end

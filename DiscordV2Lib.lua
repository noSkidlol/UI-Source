if game:GetService("CoreGui"):FindFirstChild("DiscordV2") then
  game:GetService("CoreGui"):FindFirstChild("DiscordV2"):Destroy()
end
...
function DiscordV2Lib:Frame(text,mainclr,cls)
	...
	local ServerHold = {}
	function ServerHold:Window(text, img)
		local fc = false
		...
		function ChannelHold:Tab(text)
			...
			function ChannelContent:Box(text, placetext, disapper, callback)

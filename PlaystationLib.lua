...
function Library:Notify(Option) 
local Name = Option.Name or "PlaystationUI"
local Desc = Option.Desc or "My Notification" 
...
function Library:Window(windowname,windowinfo)
    ...
    function PageYep:Page(pagename,scrollsize,visible,elementspacing)
        ...
        function PageElements:Label(labelname,labelinfo)
        ...
        function PageElements:Button(buttonname,callback)
        ...
        function PageElements:Toggle(togglename,callback)
        ...
        function PageElements:Slider(slidername,minvalue,maxvalue,callback)
        ...
        function PageElements:TextBox(textboxname,textboxdefault,callback)
        ...
        function PageElements:Dropdown(dropdownname,list,scrollsize,callback)
